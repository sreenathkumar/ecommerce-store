...
export default function ModalDelete({ closeModal }) {
   ...
   return (
      //  <!-- Main modal -->
      <div id="deleteModal" tabindex="-1" aria-hidden="true" className="overflow-y-auto overflow-x-hidden fixed top-0 left-0 left-0 z-50 justify-center items-center w-full bg-sky-800/75 md:inset-0 h-modal md:h-full">
