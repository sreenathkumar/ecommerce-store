...
export default function MenuLink({ link, children, action }) {
   ...
   return (
      ...
      }} className={`relative flex items-center w-full h-12 px-3 text-slate-50 mt-2 rounded ${pathname.match(link.title.toLowerCase()) && 'bg-gray-700 text-gray-200'} hover:bg-gray-700 hover:text-slate-50`} to={link.url}>
