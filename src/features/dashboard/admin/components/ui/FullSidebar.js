...
export default function FullSidebar({ userName, userEmail }) {
   return (
      <>
         ...
         <div className="w-full px-2 overflow-y-auto">
            <div className="flex flex-col items-center w-full mt-3 border-t border-gray-700">
               <Link className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-700 hover:text-gray-300" to="/admin/dashboard">
               ...
               <Link className="flex items-center w-full h-12 px-3 mt-2 text-gray-200 bg-gray-700 rounded" href="#">
                  <svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
         ...
         <Link className="flex items-center justify-center w-full h-16 mt-auto bg-gray-800 hover:bg-gray-700 hover:text-gray-300" href="#">
            ...
            <span className="ml-2 text-sm font-medium">{userName.length > 0 ? userName : userEmail}</span>
         </Link>
