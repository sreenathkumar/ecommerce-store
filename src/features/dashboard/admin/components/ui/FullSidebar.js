         ...
         <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 w-64 dark:bg-gray-800">
            ...
            <div className="w-full px-2 overflow-y-auto">
               <div className="flex flex-col items-center w-full mt-3 border-t border-gray-700">
                  <Link className={`flex items-center w-full h-12 px-3 text-slate-50 mt-2 rounded ${pathname === '/admin/dashboard' && 'bg-gray-700 text-gray-200'} hover:bg-gray-700 hover:text-slate-50`} to="/admin/dashboard">
                     <svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                     </svg>
                     <span className="ml-2 text-sm font-medium">Dasboard</span>
                  </Link>
                  <Link className={`flex items-center w-full h-12 px-3 text-slate-50 mt-2 rounded ${pathname === '/admin/posts' && 'bg-gray-700 text-gray-200'} hover:bg-gray-700 hover:text-slate-50`} to="/">
                     <svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                     </svg>
                     <span className="ml-2 text-sm font-medium">Posts</span>
                  </Link>
                  <Link className={`flex items-center w-full h-12 px-3 text-slate-50 mt-2 rounded ${pathname === '/admin/orders' && 'bg-gray-700 text-gray-200'} hover:bg-gray-700 hover:text-slate-50`} href="#">
                     <svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                     </svg>
                     <span className="ml-2 text-sm font-medium">Orders</span>
                  </Link>
                  <Link className={`flex items-center w-full h-12 px-3 text-slate-50 mt-2 rounded ${pathname === '/admin/insights' && 'bg-gray-700 text-gray-200'} hover:bg-gray-700 hover:text-slate-50 hover:bg-gray-700 hover:text-slate-50`} href="#">
                     <svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
               ...
               <div className="flex flex-col items-center w-full mt-2 border-t border-gray-700">
                  <Link className={`flex items-center w-full h-12 px-3 text-slate-50 mt-2 rounded ${pathname === '/admin/products' && 'bg-gray-700 text-gray-200'} hover:bg-gray-700 hover:text-slate-50`} to="/admin/products">
                     <svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
                     </svg>
                     <span className="ml-2 text-sm font-medium">Products</span>
                  </Link>
                  <Link className={`flex items-center w-full h-12 px-3 text-slate-50 mt-2 rounded ${pathname === '/admin/settings' && 'bg-gray-700 text-gray-200'} hover:bg-gray-700 hover:text-slate-50`} href="#">
                     <svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
                     </svg>
                     <span className="ml-2 text-sm font-medium">Settings</span>
                  </Link>
                  <Link className={`relative flex items-center w-full h-12 px-3 text-slate-50 mt-2 rounded ${pathname === '/admin/messages' && 'bg-gray-700 text-gray-200'} hover:bg-gray-700 hover:text-slate-50`} href="#">
                     <svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
